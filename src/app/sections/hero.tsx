  ...
  return (
    <header className="relative mb-8">
      ...
      <div className="bg-vanilla absolute left-1/2 top-[96px] flex h-32 w-10/12 -translate-x-2/4 items-center justify-center rounded-xl p-4 md:hidden">
        <h1 className="border-vanilla border-b-hero-text text-hero-text border-4 text-center text-2xl font-extrabold">
          {dict.TITLE}
        </h1>
      </div>
      <div className="aria-hidden absolute left-1/2 top-[96px] hidden -translate-x-2/4 md:block">
        <h1 className="border-b-hero-text text-vanilla border-0 border-b-4 text-center text-[6rem] font-bold [-webkit-text-stroke:#363636_4px]">
          {dict.TITLE}
        </h1>
      </div>
    </header>
